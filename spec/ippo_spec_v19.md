...
| `public/sw.js` | Service Worker（ネットワーク優先・HTML常時最新・Supabase除外） |
...
| v1.9 | 2026-04-11 | アイコン・favicon新デザイン反映・PWAキャッシュ戦略改善・更新バナー追加・CSVエクスポートにuserIdフィルター追加・待機画面に時間帯別ランダムフレーズ追加（朝/昼/夕方/夜）・待機画面の引用文ランダム表示・App Storeローンチ戦略を仕様書に追加 |
